...
if __name__ == '__main__':
    ...
    '''	
	s2_clients = []
	stage2[1] = multiprocessing.Process(name = 'stage_2[1]'%i,target = stage_2,args = (condition,))
	stage2[2] = multiprocessing.Process(name = 'stage_2[2]'%i,target = stage_2,args = (condition,))
	s2_clients.append(stage2[1])
	s2_clients.append(stage2[2])
    '''	
    for c in s2_clients:
        c.start()
        time.sleep(1)
